...
return [
    ...
    'bairros' => [
        ...
        'itens' => [
            ['h3' => 'Centro e a Alberto Andaló', 'texto' => 'Sede e o calçadão. Informe o prédio; o sentido da via muda no fim da tarde.'],
            ...
            ['h3' => 'Unesp e o campus', 'texto' => 'Pauta acadêmica. O recuo pede bloco e portaria, não GPS na reitoria.'],
        ],
    ],
    'aeroportos' => [
    ...
    'rotas' => [
        ...
        'itens' => [
            ['titulo' => 'SJP → hotel na Redentora', 'texto' => 'Pouso e pernoite. Informe o nome do hotel e se há vaga de visitante.'],
    ...
    'como' => [
        ...
        'passos' => [
            ...
            ['titulo' => 'Hotel ou SJP', 'texto' => 'Diga se o embarque é o aeroporto ou a portaria do hotel.'],
    ...
    'faq' => [
        ...
        ['pergunta' => 'O motorista espera no SJP se o voo atrasar?', 'resposta' => 'Sim. O número do voo entra no roteiro e a espera no terminal faz parte do trecho.'],
        ['pergunta' => 'Vocês esperam na porta do Hospital de Base?', 'resposta' => 'Sim, com o nome da unidade e o ponto de recuo. Evitamos o cruzamento sem aviso no horário de visita.'],
        ['pergunta' => 'Dá para seguir a São Paulo depois da reunião?', 'resposta' => 'Sim, como viagem. Não é o mesmo recorte do Centro; o horário sai sob consulta.'],
    ],
    'cta' => [
