...
return [
    ...
    'faixas' => [
        ...
        [
            ...
            'itens' => [
                ...
                ['h3' => 'Superporto e a Hidráulica', 'texto' => 'Portaria e turno. Envie o nome na lista e o documento pedido; sem isso, a cancela não libera.'],
    ...
    'faq' => [
        ...
        ['pergunta' => 'O motorista espera no RIG se o voo atrasar?', 'resposta' => 'Sim. O número do voo entra no pedido e a espera no terminal faz parte do trecho.'],
        ['pergunta' => 'Vocês entram no Superporto com protocolo de portaria?', 'resposta' => 'Sim. Envie o nome na lista e o documento pedido. Sem isso, a cancela do cais não libera.'],
        ...
        ['pergunta' => 'Dá para seguir a Pelotas depois do hotel?', 'resposta' => 'Sim, como viagem pela BR-392. Não é o mesmo recorte do Centro; o horário sai sob consulta.'],
    ],
    'cta' => [
