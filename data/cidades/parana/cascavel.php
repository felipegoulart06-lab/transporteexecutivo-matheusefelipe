...
return [
    ...
    'blocos' => [
        ...
        [
            ...
            'itens' => [
                ['h3' => 'Centro e a Brasil', 'texto' => 'Sede, hotel e o calçadão. Informe o prédio; o sentido da via muda no fim da tarde.'],
                ['h3' => 'Country, Cancelli e o shopping', 'texto' => 'Hotéis e torres. Deslocamentos curtos que esticam no semáforo da Tito Muffato.'],
                ['h3' => 'Unioeste e o campus', 'texto' => 'Pauta acadêmica. O recuo pede bloco e portaria, não “na universidade”.'],
    ...
    'grade' => [
        ...
        'itens' => [
            ['titulo' => 'CAC → hotel no Country', 'texto' => 'Pouso e pernoite. Informe o nome do hotel e se há vaga de visitante.'],
            ['titulo' => 'Country → Centro → Unioeste', 'texto' => 'Reunião, sede e campus. Um motorista cobre os três se a ordem já estiver no roteiro.'],
    ...
    'faq' => [
        ...
        ['pergunta' => 'O motorista espera no CAC se o voo atrasar?', 'resposta' => 'Sim. O número do voo entra no roteiro e a espera no terminal faz parte do trecho.'],
        ['pergunta' => 'Vocês entram na cooperativa com protocolo de portaria?', 'resposta' => 'Sim. Envie o nome na lista e o documento pedido. Sem isso, o recuo não libera.'],
